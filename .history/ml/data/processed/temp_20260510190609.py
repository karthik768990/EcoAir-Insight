...
INPUT_FILE = "ml/data/processed/cleaned_data.csv"
OUTPUT_FILE = "ml/data/processed/cleaned_data_deploy.csv"

# Column C label column
LABEL_COLUMN = "Monitoring Station"

# Maximum rows to keep per label
MAX_ROWS_PER_LABEL = 1500
...
# Keep latest records if Date column exists
